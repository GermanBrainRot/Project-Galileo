...
An "\textbf{interaction}" - whether we are in the unitary or Markovian picture - is just a transition from time $t_0$ to $t_0+\delta t$ such that

\begin{mdframed}
\begin{align*}
&P_{t\to t+\delta t}\cdot \psi (t_0) \neq P_{A, t\to t+\delta t}\cdot \psi (t_0) \cdot P_{B, t\to t+\delta t}\cdot \psi (t_0).
\end{align*}
\end{mdframed}
